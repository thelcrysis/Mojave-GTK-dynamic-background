...
wget https://raw.githubusercontent.com/thelcrysis/Mojave-GTK-dynamic-background/master/mojave.xml -P $HOME/Pictures/Wallpapers/mojave-dynamic/ 
...
sed -i -e "s/username/$USER/g" $HOME/Pictures/Wallpapers/mojave-dynamic/mojave.xml
gsettings set org.gnome.desktop.background picture-uri "file:$HOME/Pictures/Wallpapers/mojave-dynamic/mojave.xml"
